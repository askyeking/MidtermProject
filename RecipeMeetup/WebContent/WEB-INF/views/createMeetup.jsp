...
<body>
	...
	<form action="createMeetup.do" method="POST">
		...
		<h3>Address</h3>
		<input type="text" name="address.street" value="Street" maxlength="190" required /><br>
		<input type="text" name="address.city" value="City" maxlength="100" required /><br> <input
			type="text" name="address.state" value="State" maxlength="2" required /><br>
