		...
		<c:when test="${not empty loggedInUser }">
			...
			<div class="newMeetup">
				...
				<form action="addedMeetup.do" method="POST">
					...
					<h3>Address</h3>
					<input type="text" name="street" maxlength="190"
						placeholder="Street" aria-label="Street" required /><br> <input
						type="text" name="city" maxlength="100" placeholder="City"
						aria-label="City" required /><br> <input type="text"
