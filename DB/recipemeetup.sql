...
INSERT INTO `user` (`id`, `username`, `password`, `date_of_birth`, `first_name`, `last_name`, `address_id`, `description`, `create_date`, `active`, `admin`, `img_url`, `email`) VALUES (5, 'CodysKitchen', 'Jones1', '1989-06-12', 'Cody', 'Jones', 5, 'I love southern food with a healthy twist.', DEFAULT, DEFAULT, DEFAULT, 'https://images.pexels.com/photos/736716/pexels-photo-736716.jpeg?auto=compress&cs=tinysrgb&h=350', 'cody@aol.com');
INSERT INTO `user` (`id`, `username`, `password`, `date_of_birth`, `first_name`, `last_name`, `address_id`, `description`, `create_date`, `active`, `admin`, `img_url`, `email`) VALUES (6, 'Jackiesfineknives', 'finePass101', '1970-12-21', 'Jackie', 'Smith', 6, 'I love inviting friends over for dinner. I\'ll cook anything from Pad Thai to fried ice cream.', DEFAULT, DEFAULT, DEFAULT, 'https://images.pexels.com/photos/712513/pexels-photo-712513.jpeg?auto=compress&cs=tinysrgb&h=350', 'JackieS@gmail.com');
INSERT INTO `user` (`id`, `username`, `password`, `date_of_birth`, `first_name`, `last_name`, `address_id`, `description`, `create_date`, `active`, `admin`, `img_url`, `email`) VALUES (7, 'Friedfoodlover', 'osg123', '1988-10-13', 'Cletus', 'McAlister', 8, 'Fried, fried, fried and more fried.  Sign me up for anything fried.', DEFAULT, DEFAULT, DEFAULT, 'http://www.jardine-electronics.com/athletics/images/Cletus.jpg', 'cletus.mcalister@gmail.com');
COMMIT;
-- -----------------------------------------------------
