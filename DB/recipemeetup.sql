...
INSERT INTO `user` (`id`, `username`, `password`, `date_of_birth`, `first_name`, `last_name`, `address_id`, `description`, `create_date`, `active`, `admin`, `img_url`, `email`) VALUES (4, 'novienov', 'AcTb432yESV460', '1994-10-16', 'Novak', 'Longsurnameovich', 4, 'Any food is good food. Any place is a good place to make it with fun people.', DEFAULT, DEFAULT, DEFAULT, DEFAULT, 'novinov@aol.com');
