...
START TRANSACTION;
USE `recipemeetupdb`;
INSERT INTO `user` (`id`, `username`, `password`, `date_of_birth`, `first_name`, `last_name`, `address_id`, `description`, `create_date`, `active`, `admin`, `img_url`, `email`) VALUES (1, 'blake234', 'hashedPass1', '1997-03-05', 'Blake', 'Shelton', 1, 'Fun, Smart, love cooking casseroles.', DEFAULT, DEFAULT, DEFAULT, NULL, 'blake@gmail.com');
INSERT INTO `user` (`id`, `username`, `password`, `date_of_birth`, `first_name`, `last_name`, `address_id`, `description`, `create_date`, `active`, `admin`, `img_url`, `email`) VALUES (2, 'anthony_prince', 'Prince', '1989-02-01', 'Anthony', 'Prince', 2, 'Love for fine American cuisine.', DEFAULT, DEFAULT, DEFAULT, NULL, 'aprince@yahoo.com');
INSERT INTO `user` (`id`, `username`, `password`, `date_of_birth`, `first_name`, `last_name`, `address_id`, `description`, `create_date`, `active`, `admin`, `img_url`, `email`) VALUES (3, 'newel1', 'aAse3G2013', '1988-03-08', 'Newel', 'New', 3, 'Love European food. They even used to call me the European kid.', DEFAULT, DEFAULT, DEFAULT, NULL, 'newel@hotmail.com');
INSERT INTO `user` (`id`, `username`, `password`, `date_of_birth`, `first_name`, `last_name`, `address_id`, `description`, `create_date`, `active`, `admin`, `img_url`, `email`) VALUES (4, 'novienov', 'AcTb432yESV460', '1994-10-16', 'Novak', 'Longsurnameovich', 4, 'Any food is good food. Any place is a good place to make it with fun people.', DEFAULT, DEFAULT, 1, NULL, 'novinov@aol.com');
INSERT INTO `user` (`id`, `username`, `password`, `date_of_birth`, `first_name`, `last_name`, `address_id`, `description`, `create_date`, `active`, `admin`, `img_url`, `email`) VALUES (5, 'codjones', 'jones1', '1955-06-12', 'Code', 'Jones', 5, 'I love southern food with a healthy spin.', DEFAULT, DEFAULT, DEFAULT, NULL, 'cody@codyjones.com');
INSERT INTO `user` (`id`, `username`, `password`, `date_of_birth`, `first_name`, `last_name`, `address_id`, `description`, `create_date`, `active`, `admin`, `img_url`, `email`) VALUES (6, 'jakiechan123', 'finePass101', '1970-12-21', 'Jack', 'Bryan', 6, 'I love inviting friends over for dinner. I\'ll cook anything from Pad Thai to fried ice cream.', DEFAULT, DEFAULT, DEFAULT, NULL, 'codejones@gmail.com');
INSERT INTO `user` (`id`, `username`, `password`, `date_of_birth`, `first_name`, `last_name`, `address_id`, `description`, `create_date`, `active`, `admin`, `img_url`, `email`) VALUES (7, 'cletus23', 'osgdfs23', '1988-10-13', 'Cletus', 'McAlister', 8, NULL, DEFAULT, DEFAULT, DEFAULT, NULL, 'bryan.mcalister@gmail.com');
